        ...
        <div id="header-inner-nav" className="header-inner-container">
          ...
          <div id="header-right-actions-group" className="header-actions-right">
            <Link
              ...
              className={`header-account-action${isActive('/account') ? ' active' : ''}`}
            ...
            >
              <span id="theme-toggle-icon-container" className="theme-toggle-icon-wrap" aria-hidden="true" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 24, height: 24, minWidth: 24, padding: 0, margin: 0, background: 'transparent', border: 0, borderRadius: 0, boxShadow: 'none', lineHeight: 1, overflow: 'visible' }}>
                <i className="material-symbols-outlined" style={{ display: 'block', width: '1em', height: '1em', margin: 0, lineHeight: 1, fontSize: 20 }}>
